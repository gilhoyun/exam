...
class ExamApplicationTests {
	...
	void t2() {
		...
		bookStoreRepository.insertBookStore("코리아서점");
		bookStoreRepository.insertBookStore("아이티문고");
	}
	...
	void t3() {
		...
		List<BookStoreVO> books = bookStoreRepository.selectBookStore();
		
		System.out.println("== 모든 서점 정보 ==");
		for(int i = 0; i < books.size(); i++) {
			BookStoreVO bStore = books.get(i);
	...
	@Test
	void t4() {
		bookStoreRepository.modifyBookStore(2, "IT문고");
	...
	void t5() {
		...
		bookRepository.insertBook("죄와벌", "도스토예프스키", 1);
	...
	@Test
	void t6() {
		List<BookVO> books = bookRepository.selectBookTitle();
	...
	@Test
	void t7() {
		List<BookVO> books = bookRepository.selectKoreaBook("코리아서점");
